      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="user-block block text-center">
            <div class="avatar"><img src="backend/img/avatar-1.jpg" alt="..." class="img-fluid">
        ...
        <div class="col-lg-4">
          <div class="user-block block text-center">
            <div class="avatar"><img src="backend/img/avatar-4.jpg" alt="..." class="img-fluid">
        ...
        <div class="col-lg-4">
          <div class="user-block block text-center">
            <div class="avatar"><img src="backend/img/avatar-6.jpg" alt="..." class="img-fluid">
      ...
      <div class="public-user-block block">
        <div class="row d-flex align-items-center">
          <div class="col-lg-4 d-flex align-items-center">
            ...
            <div class="avatar"> <img src="backend/img/avatar-1.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Tomas Hecktor</strong><span class="d-block">@tomhecktor</span></a>
          </div>
      ...
      <div class="public-user-block block">
        <div class="row d-flex align-items-center">
          <div class="col-lg-4 d-flex align-items-center">
            ...
            <div class="avatar"> <img src="backend/img/avatar-2.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Alexander Shelby</strong><span class="d-block">@alexshelby</span></a>
          </div>
          <div class="col-lg-4 text-center">
      ...
      <div class="public-user-block block">
        <div class="row d-flex align-items-center">
          <div class="col-lg-4 d-flex align-items-center">
            ...
            <div class="avatar"> <img src="backend/img/avatar-6.jpg" alt="..." class="img-fluid"></div><a href="#" class="name"><strong class="d-block">Arther Kooper</strong><span class="d-block">@artherkooper</span></a>
          </div>
          <div class="col-lg-4 text-center">
        ...
        <div class="col-lg-6">
          <div class="messages-block block">
            ...
            <div class="messages"><a href="#" class="message d-flex align-items-center">
                <div class="profile"><img src="backend/img/avatar-3.jpg" alt="..." class="img-fluid">
                ...
                <div class="profile"><img src="backend/img/avatar-2.jpg" alt="..." class="img-fluid">
                ...
                <div class="profile"><img src="backend/img/avatar-1.jpg" alt="..." class="img-fluid">
                ...
                <div class="profile"><img src="backend/img/avatar-5.jpg" alt="..." class="img-fluid">
